...
namespace ManageStuDAO
{
    public class DataProvider
    {
        public static string connectionString
        {
            get
            {
                return "Data Source=DESKTOP-V53VS56\\SQLEXPRESS; Initial Catalog=BookStore_Management; Integrated Security=True; TrustServerCertificate = True;";
            }
        }
        //Thêm vào phương phức lấy chuỗi kết nối
        public static SqlConnection GetConnection()
        {
            SqlConnection connect = new SqlConnection(connectionString);
            connect.Open(); // Mở kết nối
            return connect; // Trả về đối tượng kết nối
        }
